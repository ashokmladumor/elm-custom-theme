...
$this->add_control(
    'program_tab_toggle',
    [
        'label' => esc_html__('Program Tab (Show/Hide)', 'ippi'),
        'type' => Controls_Manager::SWITCHER,
        'default' => 'yes',
        'label_on' => __('Show', 'ippi'),
        'label_off' => __('Hide', 'ippi'),
...
$this->add_control(
    'program_tab',
    [
        'label' => esc_html__( 'Program Tab', 'ippi' ),
        'type' => \Elementor\Controls_Manager::SELECT,
        'multiple' => true,
        'options' => [
            'all-programs'  => esc_html__( 'All Programs', 'ippi' ),
            'current-programs' => esc_html__( 'Current Programs', 'ippi' ),
            'past-programs' => esc_html__( 'Past Programs', 'ippi' ),
        ],
        'default' => [ 'all' ],
        'condition' => [
            'program_tab_toggle' => '',
...
$this->add_control(
    ...
    [
        ...
        'default' => [ 'all' ],
        'condition' => [
            'program_tab_toggle' => 'yes',
        ],
    ]
);

$this->add_control('include_programs_term_ids', [
...
$this->add_control('include_programs_tag_ids', [
