...
$this->add_control(
    'event_tab',
    [
        'label' => esc_html__( 'Event Tab', 'ippi' ),
        'type' => \Elementor\Controls_Manager::SELECT,
        'multiple' => true,
        'options' => [
            'all'  => esc_html__( 'All', 'ippi' ),
            'upcoming' => esc_html__( 'Upcoming', 'ippi' ),
            'past-events' => esc_html__( 'Past Events', 'ippi' ),
        ],
        'default' => [ 'all' ],
        'condition' => [
            'event_tab_toggle' => '',
